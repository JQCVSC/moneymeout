...
const PrivacyPage: React.FC<PrivacyPageProps> = ({ navigateTo }) => {
  return (
    <div className="min-h-screen bg-[#090d16] text-white flex flex-col selection:bg-[var(--success-color)] selection:text-black">
      ...
      <main className="flex-grow py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <motion.div 
            ...
            className="glass-panel border-white/10 rounded-2xl p-8 sm:p-12 shadow-2xl"
          >
            <div className="flex flex-wrap gap-4 mb-8">
              <button 
                onClick={() => navigateTo('search')}
                className="inline-flex items-center px-5 py-2.5 rounded-full bg-[var(--success-color)] text-black font-bold hover:brightness-110 active:scale-95 transition-all shadow-md shadow-emerald-500/20 group"
              >
              ...
              <button 
                ...
                className="inline-flex items-center px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-white font-bold hover:bg-white/10 transition-all shadow-sm"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[var(--success-color)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-slate-400 mb-10 text-sm">Last Updated: July 30, 2026</p>
            ...
            <div className="text-slate-300 leading-relaxed space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">1. Google and YouTube API Services</h2>
                <p>Money Me Out uses YouTube API Services to verify creator identity and fetch channel metadata. By using our Service, you agree to be bound by the <a href="https://www.youtube.com/t/terms" target="_blank" rel="noopener noreferrer" className="text-[var(--success-color)] hover:underline font-medium">YouTube Terms of Service</a>.</p>
                <p className="mt-2">For more information on how Google handles your data, please review the <a href="http://www.google.com/policies/privacy" target="_blank" rel="noopener noreferrer" className="text-[var(--success-color)] hover:underline font-medium">Google Privacy Policy</a>.</p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Stripe:</strong> For secure payment processing, identity verification, and payout routing. Please review <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[var(--success-color)] hover:underline">Stripe's Privacy Policy</a>.</li>
              ...
              <section>
                ...
                <p className="mb-3"><strong>Your Rights:</strong> You have the right to request the deletion of your account and associated personal data. To request data deletion, please contact us via our <button onClick={() => navigateTo('contact')} className="text-[var(--success-color)] hover:underline">contact form</button> or email support@moneymeout.com.</p>
                <p>Additionally, you can revoke Money Me Out's access to your YouTube data at any time via your Google Account's <a href="https://security.google.com/settings/security/permissions" target="_blank" rel="noopener noreferrer" className="text-[var(--success-color)] hover:underline">Security Settings page</a>.</p>
              </section>

              <section>
                <h2 className="text-2xl font-bold text-white mb-4">6. Contact Us</h2>
                <p>If you have any questions about this Privacy Policy, please reach out via our <button onClick={() => navigateTo('contact')} className="text-[var(--success-color)] hover:underline inline">contact form</button> or email support@moneymeout.com.</p>
              </section>
            </div>
          </motion.div>
        </div>
