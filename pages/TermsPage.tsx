          ...
          >
            ...
            <div className="text-slate-300 leading-relaxed space-y-8">
              ...
              <section>
                ...
                <p className="mt-2">Because Money Me Out utilizes YouTube API Services to operate, by using our Service, you also explicitly agree to be bound by the <a href="https://www.youtube.com/t/terms" target="_blank" rel="noopener noreferrer" className="text-[var(--success-color)] hover:underline font-medium">YouTube Terms of Service</a>.</p>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">3. Financial Terms, Fees, and Payouts</h2>
                <ul className="list-disc pl-6 space-y-3">
                  ...
                  <li><strong>Stripe Connect:</strong> To receive funds, creators must successfully complete onboarding via Stripe Connect Express. You agree to comply with the <a href="https://stripe.com/connect-account/legal" target="_blank" rel="noopener noreferrer" className="text-[var(--success-color)] hover:underline">Stripe Connected Account Agreement</a>.</li>
              ...
              <section>
                ...
                <p>For any questions regarding these Terms, please reach out via our <button onClick={() => navigateTo('contact')} className="text-[var(--success-color)] hover:underline inline">contact form</button> or email support@moneymeout.com.</p>
              </section>
            </div>
          </motion.div>
        </div>
